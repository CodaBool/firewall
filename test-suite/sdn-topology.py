...
class FirewallTopo(Topo):
    ...
    def __init__(self, cpu=.1, bw=10, delay=None, **params):
        ...
        other1 = self.addHost( 'other1', ip='10.0.200.1', mac='00:00:00:55:aa:2d', **hconfig)
        self.addLink(s1,other1)
        other2 = self.addHost( 'other2', ip='10.0.120.25', mac='00:00:99:1a:2c:3f', **hconfig)
        self.addLink(s1,other2)
